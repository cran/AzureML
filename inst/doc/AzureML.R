...
##                               list("x"="float", "y"="float"), list("z"="float"), myWsID, myAuth, [url])

## ----load, eval=FALSE----------------------------------------------------
## loadSettings()

## ----publishAfterLoad, eval=FALSE----------------------------------------
## response <- publishWebService("add", "addOnline",
##                               list("x"="float", "y"="float"), list("z"="float"))
...
## 
## # If the workspace was configured through loadSettings()
## endpoints <- getEndpoints(wsID = webservices[[1]]$Id)
